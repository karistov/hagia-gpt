...
title = "PDF GPT"
description = """ ## Hagia PDF GPT allows you to chat with your PDF file using Universal Sentence Encoder and Open AI. It gives hallucination free response than other tools as the embeddings are better than OpenAI. The returned response can even cite the page number in square brackets([]) where the information is located, adding credibility to the responses and helping to locate pertinent information quickly."""

with gr.Blocks() as demo:
    gr.Markdown('<center><img src="https://github.com/karistov/hagia-gpt/blob/main/assets/hagia-logo.png?raw=true"> </center>')
...
demo.launch(
    server_name="0.0.0.0", server_port=7862, enable_queue=True
